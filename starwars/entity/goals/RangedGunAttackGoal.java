...
public class RangedGunAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
    ...
    public boolean shouldExecute() {
        return this.isGunInMainhand() || this.entity.getAttackTarget() != null && this.isGunInMainhand() && (entity.isAggressive() || entity.getAttackTarget().getHeldItemMainhand().getItem() == ModItems.LIGHTSABER || !(entity.getAttackTarget() instanceof PlayerEntity));
    }

    private boolean isGunInMainhand() {
        return this.entity.getHeldItemMainhand().getItem() instanceof ShootingItem || this.entity.getHeldItemOffhand().getItem() instanceof ShootingItem;
    }
    ...
    public boolean shouldContinueExecuting() {
        return (this.entity.getAttackTarget() != null || !this.entity.getNavigator().noPath()) && this.isGunInMainhand() || entity.isAggressive() && this.isGunInMainhand();
    }
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.entity.isHandActive()) {
                ...
                this.entity.setActiveHand(ProjectileHelper.getHandWith(this.entity, ModItems.BLASTER_RIFLE));
            }
