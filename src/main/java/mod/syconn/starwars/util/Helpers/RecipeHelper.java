...
public class RecipeHelper {
    ...
    public ItemStack createLightsaber(KyberCrystalItem item){
        ItemStack lightsaber = ModItems.LIGHTSABER.getDefaultInstance().getStack();
        LightsaberItem.setLightsaberColor(lightsaber, LightsaberItem.getLightsaberColor(item.getDefaultInstance().getStack()));
        return lightsaber;
    }
}
