...
public class StructureHandler {
    ...
    private static void addCrystalCave(Biome biome){
        ConfiguredFeature<CrystalCaveConfig, ? extends Structure<CrystalCaveConfig>> crystalCave = ModFeatures.CRYSTAL_CAVE.get().withConfiguration(new CrystalCaveConfig(Config.COMMON.caveCampGenerateChance.get(), CrystalCave.CRYSTAL_CAVE));
