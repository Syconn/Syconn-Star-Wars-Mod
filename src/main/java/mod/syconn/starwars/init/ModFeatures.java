...
public class ModFeatures {
    ...
    public static final RegistryObject<CrystalCaveStructure> CRYSTAL_CAVE = REGISTER.register("crystal_cave", () -> new CrystalCaveStructure(OreFeatureConfig::deserialize));
}